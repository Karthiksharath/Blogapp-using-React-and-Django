//  the useAuthStore hook from the '../store/auth' file to manage authentication state
import { useAuthStore } from "../store/auth";

//  the axios library for making HTTP requests
import axios from "./axios";

//  jwt_decode to decode JSON Web Tokens
import jwt_decode from "jwt-decode";

//  Cookies library to handle browser cookies
import Cookies from "js-cookie";

//  Swal (SweetAlert2) for displaying toast notifications
import Swal from "sweetalert2";

// global toast notifications using Swal.mixin
